...
/**
 * Created by gf on 2018/7/16.
 */

public class ProcessUtil {
    public static volatile String DEFAULT_PROCESS = "";

    public static final String UNKNOWN_PROCESS_NAME = "unknown_process_name";

    public static final String IPC_AUTHORITY_SUFFIX = ".RouterIPCProvider";

    public static String getIPCProviderAuthority(Context context) {
        return ProcessUtil.getProcessName(context)+IPC_AUTHORITY_SUFFIX;
    }
